...
import com.jero3000.appinstaller.repository.credential.json.CredentialDto
import com.jero3000.appinstaller.repository.credential.json.toCredential
...
class CredentialPreferencesDataSource(settingsFactory: Settings.Factory, private val ioContext: CoroutineContext): CredentialDataSource {
    ...
    override suspend fun deleteCredential(host: String) = withContext(ioContext) {
